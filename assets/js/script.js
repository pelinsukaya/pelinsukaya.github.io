...
(function initI18n() {
  const translations = {
    ...
    tr: {
      ...
      'nav.openCv': 'CV\'yi Aç',
      'hero.title': 'Yeni Medya ve Fikri Mülkiyet Hukuku alanında uzman bir avukatım',
      'hero.subtitle': 'Merhaba! Ben Pelinsu Kaya. Sözleşmeler hukuku, fikri mülkiyet ve yeni medya hukuku alanlarında uzman bir hukukçuyum. Eğlence ve medya sektörüne odaklı olarak hukuki danışmanlık, sözleşme hazırlama ve vekillik hizmetleri sunuyorum.',
      'hero.seeWorks': 'Çalışmalarıma Göz At',
      'hero.contactMe': 'Benimle İletişime Geç',
      'about.title': 'Ne Yapıyorum?',
      'about.text': 'Hypers New Medya\'da avukat olarak karmaşık sözleşmelerin hazırlanması, fikri mülkiyet danışmanlığı ve dava süreçlerinin yönetimi konularında uzmanlaştım. Türkçe ve İngilizce hukuki dokümantasyon tecrübesi ile eğlence ve medya sektörüne kapsamlı hukuki çözümler sunuyorum.',
      ...
      'about.ipText': 'Marka hukuku alanında danışmanlık, başvuru ve itiraz süreçlerinde destek, fikri mülkiyet muvafakat formlarının hazırlanması',
      'about.legalTranslation': 'Hukuki Çeviri',
      'about.legalTranslationText': 'İngilizce ve Türkçe arasında hukuki belgeler, sözleşmeler ve yargılama süreçlerinin profesyonel çevirisi',
      ...
      'background.currentText': 'Sözleşme hazırlama, fikri mülkiyet ve dava yönetimi konularında uzman avukat. Eğlence ve medya sektörüne kapsamlı hukuki çözümler sunuyorum.',
      'background.education': 'Eğitim',
      'background.educationText': 'Hukuk Fakültesi mezunu, %25 Başarı Bursu. AGNO: 2.88. Uluslararası Bakalorya (IB) Diploma Programı mezunu, puan: 35/42.',
      ...
      'background.speakingText': 'Marmara Üniversitesi "Yeni Medya Hukuku" ve Kadir Has Üniversitesi "Çevrimiçi Dünyanın Kuralları: Sosyal Medya Hukuku" seminerlerinde konuşmacı',
      'background.skillsLanguages': 'Yetenekler ve Diller',
      'background.competencies': 'Profesyonel Yeterlilikler',
      'background.competenciesText': 'İngilizce ve Türkçe akıcı, temel seviyede İspanyolca ve Türk İşaret Dili. Sözleşmeler hukuku, hukuki yazım ve yeni medya hukuku alanlarında uzman',
      'background.visitHypers': 'Web Sitesini Ziyaret Et',
      'contact.title': 'Gördüklerinizi beğendiyseniz birlikte çalışalım.',
      'contact.text': 'Müvekkillerimin hayatını kolaylaştırmak için hızlı çözümler üretirim. Sorularınız mı var? Bu iletişim üzerinden bana ulaşın, en kısa sürede dönüş yapayım.',
